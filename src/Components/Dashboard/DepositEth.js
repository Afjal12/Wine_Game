...
const [token ,setToken] = useState('');
    ...
    const clickHeading = () => {
        setHeading('Connect your wallet First')
    }
    return (
        <>
            <div className='d-flex dashboard-body pt-3 justify-content-between'>
                <div className='col-md-5  font-token p-4 token-border  '>

                    <h1 className='text-center text-primary'>Deposit Eth</h1>
                    {userConnected == true ? '' : <p className='text-center text-danger'>{heading}</p>}
                    <p>Network : Matic</p>

                    <span>Tokens</span><br />
                    <p>

                        <input type="number" className='form-control bg-dark text-white'  onChange={handleChange} placeholder='No of Tokens' />
                    </p>
                    ...
                    <p className='text-center'>
                        ...
                        <button className='btn btn-primary w-100' onClick={userConnected == true ? ClickDepositEth : clickHeading}>Submit</button>
                    </p>
